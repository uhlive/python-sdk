...
class TestConnection(TestCase):
    def test_join(self):
        ...
        self.assertEqual(
            frame,
            r'["1","1","conversation:customerid@myconv","phx_join",{"readonly":false,"speaker":"john_test","model":"en","country":"us","interim_results":true,"rescoring":true,"origin":0,"codec":"linear"}]',
        )
